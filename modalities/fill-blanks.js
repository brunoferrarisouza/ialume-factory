const FILL_BLANKS = {
    ...
    injectCSS: function() {
        ...
        style.textContent = `
            ...
            .fb-header { background: white; border: 3px solid #667eea; border-radius: 20px; padding: 30px; margin-bottom: 30px; text-align: center; box-shadow: 0 4px 15px rgba(0,0,0,0.1); }
            .fb-icon { font-size: 3.5rem; margin-bottom: 10px; }
            .fb-title { font-size: 1.3rem; font-weight: 600; color: #495057; }
            .fb-sentence { background: white; border: 3px solid #667eea; border-radius: 20px; padding: 40px; margin-bottom: 30px; font-size: 1.8rem; font-weight: 600; color: #212529; line-height: 2.5; text-align: center; box-sizing: border-box; overflow-wrap: break-word; word-break: break-word; }

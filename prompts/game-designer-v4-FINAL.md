# 🎮 PROMPT GAME DESIGNER V2.0 (ATUALIZADO)

**Data:** 2025-11-07
**Status:** ✅ PRONTO PARA USO
**Compatível com:** game-engine.js + escalada.js + audio.js + particles.js

---

## 📌 MUDANÇAS PRINCIPAIS DA V1 → V2

### ❌ REMOVIDO (estrutura antiga que não funciona):
```json
{
  "mechanic": { "name": "escalada", "rationale": "..." },
  "modality": { "name": "mixed", "rationale": "..." },
  "character": { "name": "Lume", "quotes": {...} },
  "narrative": { "theme": "...", "hero": "Lume", ... },
  "difficulty": {...},
  "questions": [...]
}
```

### ✅ NOVO (estrutura que o game-engine.js espera):
```json
{
  "titulo": "...",
  "tema": "...",
...
### MECÂNICAS (2 disponíveis no MVP):

**escalada** - Subir montanha
- Melhor para: progressão, crescimento, acúmulo, sequências crescentes
- Evitar: subtração, decrescimento

**perseguicao** - Fugir de perigo
- Melhor para: velocidade, urgência, sequências, raciocínio rápido
- Evitar: reflexão profunda, cálculos complexos
...
- **perseguicao**: urgência, velocidade, fuga
